...
UIL Competition Practice (Each of these contain context inside of them + input/output examples):
...
Pranav.java - A game simulator where I had to calculate the scores of both players if they play absolutely ideally. I used memoization which is always cool to use!
Ruth.java - A rain catching problem, where heights of walls are given, and the amount of water that can be filled into them must be returned. This was my first solution and it uses quadratic time
RuthImproved.java - A return to Ruth.java where I took a little more time at the drawing board to find a faster way to do it.
